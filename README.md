Nexa\_v1 - LAN Peer-to-Peer Messenger (C / WinSock2)
...
Nexa\_v1 est une application de messagerie Peer-to-Peer (P2P)
...
\-   udp\_listener : écoute les broadcasts UDP

\-   tcp\_listener : reçoit les messages TCP

\-   sender\_thread : envoie les broadcasts et renvoie les messages non

&nbsp;   confirmés



Synchronisation via CRITICAL\_SECTION pour éviter les conflits d’accès
...
gcc main.c -o Nexa\_v1.exe -lws2\_32
